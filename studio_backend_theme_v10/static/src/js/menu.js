odoo.define('studio_backend_theme_v10.Menu', function (require) {
"use strict";
...
var Menu = Widget.extend({
    ...
    events: {
        'click .o_menu_toggle': function (ev) {
            ev.preventDefault();
            this.trigger_up((this.appchanger_displayed)? 'hide_app_changer' : 'show_app_changer');
    ...
    init: function (parent, menu_data) {
        ...
        this.appchanger_displayed = true;
    ...
    toggle_mode: function (appchanger, overapp) {
        this.appchanger_displayed = !!appchanger;
        this.backbutton_displayed = this.appchanger_displayed && !!overapp;

        this.$menu_toggle.toggleClass('fa-chevron-left', this.appchanger_displayed)
                         .toggleClass('fa-th', !this.appchanger_displayed);
        if (this.appchanger_displayed && !this.backbutton_displayed) {
            this.$menu_toggle.removeAttr('accesskey');
        } else {
            this.$menu_toggle.attr('accesskey', 'h');
        }
        this.$menu_toggle.toggleClass('hidden', this.appchanger_displayed && !this.backbutton_displayed);
        this.$menu_brand_placeholder.toggleClass('hidden', this.appchanger_displayed);
        this.$section_placeholder.toggleClass('hidden', this.appchanger_displayed);
    },
