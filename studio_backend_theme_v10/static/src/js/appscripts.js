odoo.define('studio_backend_theme_v10.apps', function (require) {
"use strict";
...
odoo.define('studio_backend_theme_v10.AppChanger', function (require) {
"use strict";
...
var AppChanger = Widget.extend({
    ...
    start: function () {
        ...
        this.$main_content = this.$('.o_application_changer_scrollable');
        ...
        visit(menu_data, function (menu_item, parents) {
            ...
            if (!menu_item.parent_id) {
                if (menu_item.web_icon_data) {
                    ...
                    item.web_icon_data = '/studio_backend_theme_v10/static/src/img/default_icon_app.png';
                }
            } else {
    ...
    render: function() {
        ...
        this.$main_content.html(QWeb.render('AppChanger.Content', { widget: this }));
...
odoo.define('studio_backend_theme_v10.ViewManager', function (require) {
"use strict";
var config = require('web.config');
...
odoo.define('studio_backend_theme_v10.ControlPanel', function (require) {
"use strict";
